...
if [ "${1,,}" == hdmi ]; then
    ...
    cp ~/Software/Git/Malfatti/SciScripts/Bash/ALSA/PCHVol.sh ~/Software/Git/Malfatti/SciScripts/Bash/ALSA/VolControl.sh
    bash ~/Software/Git/Malfatti/SciScripts/Bash/ALSA/JackCtl.sh --path "$JackPath" --rt r --card PCH --rate 48000 --periodsize 1024 --periods 3 --priority 19

elif [ "${1,,}" == jackrt ]; then
    killall jackd &> /dev/null
    cp ~/Software/Git/Malfatti/SciScripts/Bash/ALSA/Jack-ALSA ~/.asoundrc
    cp ~/Software/Git/Malfatti/SciScripts/Bash/ALSA/PCHVol.sh ~/Software/Git/Malfatti/SciScripts/Bash/ALSA/VolControl.sh
    bash ~/Software/Git/Malfatti/SciScripts/Bash/ALSA/JackCtl.sh --path "$JackPath" --rt R --card PCH --rate 192000 --periodsize 384 --periods 3 --priority 89

elif [ "${1,,}" == jackusbpre2 ]; then
    killall jackd &> /dev/null
    cp ~/Software/Git/Malfatti/SciScripts/Bash/ALSA/Jack-ALSA ~/.asoundrc
    cp ~/Software/Git/Malfatti/SciScripts/Bash/ALSA/PCHVol.sh ~/Software/Git/Malfatti/SciScripts/Bash/ALSA/VolControl.sh
    bash ~/Software/Git/Malfatti/SciScripts/Bash/ALSA/JackCtl.sh --path "$JackPath" --rt R --card USBPre2 --rate 192000 --periodsize 384 --periods 3 --priority 89
